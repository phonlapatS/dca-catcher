...
ภาพด้านล่างคือตัวอย่างผลลัพธ์จริงที่โมดูล `src/charting.py` สร้างขึ้นใน RAM และส่งเข้าสู่ Telegram:
...
| *ขยายเป็น 6 เดือนอัตโนมัติเพื่อให้เส้นไม้ 3 (T3: $189.48) พาดทับแนวรับในอดีตจริง* | *แสดงเส้นราคาปัจจุบัน (เขียว) และระดับเป้าหมาย 3 ไม้ (ฟ้า) พร้อมป้ายราคาชัดเจน* |
