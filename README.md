...
## 🚀 What's New in Phase 6 (พัฒนาต่อยอดจาก Phase 5 อย่างไร?)

แม้ Phase 5 จะมีบทวิเคราะห์ที่ยอดเยี่ยม แต่ AI ยังคง "ความจำสั้น" สำหรับ **Phase 6** นี้ เราได้แก้ปัญหาดังกล่าวโดยการสร้าง:
1. **Adaptive AI Memory:** ระบบความจำต่อเนื่อง (2+1 Memory Window) ที่ช่วยให้บอทจำได้ว่าเคยวิเคราะห์หุ้นตัวนี้ไปเมื่อไหร่ ราคาตอนนั้นเท่าไหร่ และสมมติฐานเดิมคืออะไร
2. **Storyline Continuity:** AI สามารถเชื่อมโยงเหตุการณ์อดีตถึงปัจจุบัน และให้ข้อสรุปว่าเป้าหมายเดิมยังใช้ได้ (Continuing) หรือต้องเปลี่ยนแผน (Invalidated)
3. **ML Uncertainty Calibration:** เพิ่มระบบประเมินความมั่นใจของ AI (0-100%) ตามหลัก Machine Learning เพื่อให้ผู้ใช้วางแผนน้ำหนักการลงทุนได้อย่างปลอดภัย
